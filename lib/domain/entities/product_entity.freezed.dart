...
class _$ProductEntityImpl implements _ProductEntity {
  ...
  @override
  String toString() {
    return 'ProductEntity(id: $id, name: $name, description: $description, price: $price, imageUrl: $imageUrl, category: $category, alcoholPercentage: $alcoholPercentage, origin: $origin)';
  }
